...
[![Gratipay][gratipay-image]][gratipay-url]
  This is a customization of the loopback-jwt package. It has been altered to:
  - Expect a options.secretKey Promise returning a base64 buffer instead of string.
  - Log an error instead of calling createUser if the user fails to authenticate.
